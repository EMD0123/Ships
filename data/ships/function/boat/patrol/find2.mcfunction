...
execute as @e[tag=ships.boatai.patrol.selected,limit=1,sort=nearest] at @s facing entity @e[tag=ships.boatai.patrol.find] feet positioned as @s run rotate @s ~ ~
